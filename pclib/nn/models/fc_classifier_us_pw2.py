    ...
    def init_layers(self):
        ...
        for out_features in [self.in_features] + self.hidden_sizes:
            if self.precision_weighted:
                ...
                layers.append(FCPW2(in_features, out_features, device=self.device, **self.factory_kwargs))
